...
![Registration](./docs/img/front-registration.png)

2) Provide login

![Login](./docs/img/front-login.png)

3) Provide list of users

![Users list](./docs/img/front-users-list.png)

4) Provide conversation between users

![Conversation](./docs/img/front-hagrid-harry.png)

Additionally:

 - Application does look for bad guys

    ![Bad guys](./docs/img/front-draco-harry.png)

    ![Bad guys](./docs/img/front-draco-hermione.png)

    ![Bad guys](./docs/img/front-toxic.png)

 - Application does look for spammers

    ![Spam](./docs/img/front-ron-dung.png)

    ![Spam](./docs/img/front-spam.png)

5) Not allow blocked users to login again

![Blocked](./docs/img/front-mundungus-fletcher.png)

### Implementation

![Components](./docs/img/front-components.png)
